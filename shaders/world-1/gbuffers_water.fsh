...
void main() {
    ...
    // Entfernte Caustik-Code:
    /*
    if (material(0.1)) {
        vec2 causticCoord = worldposition.xz / causticScale + frameTimeCounter * 0.1;
        vec3 caustic = texture2D(causticTex, causticCoord).rgb * causticStrength;
